...
urlpatterns = [
    ...
    url(r'^panel/manager/del/(?P<pk>\d+)/$', views.manager_delete, name='manager_delete'),
    ...
    url(r'^panel/manager/addtogroups/(?P<pk>\d+)/$', views.add_users_to_groups, name='add_users_to_groups'),
    ...
    url(r'^panel/manager/group/delperm/(?P<gname>.*)/(?P<name>.*)/$', views.groups_perms_del, name='groups_perms_del'),
    url(r'^panel/manager/group/addperm/(?P<name>.*)/$', views.groups_perms_add, name='groups_perms_add'),
